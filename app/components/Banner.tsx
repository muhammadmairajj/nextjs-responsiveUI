  ...
  return (
    <div className="pt-4 lg:pt-10">
      <div className="px-[20px] lg:px-[280px]">
        ...
        <p className="pt-6 text-[#36485C] text-center lg:text[18px] lg:leading-7">
        ...
        <div className="flex w-full pt-8 justify-center gap-x-6">
          <button className="lg:w-fit w-1/2 bg-[#4328EB] text-[#FFFFFF] py-4 px-8 rounded-[4px] cursor-pointer">
            Try for free
          </button>
          <button className="lg:w-fit w-1/2 bg-[#FFFFFF] text-[#4328EB] flex items-center justify-center gap-x-2 cursor-pointer">
            View Pricing
